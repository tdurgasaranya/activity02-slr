...
### Section 2(Day 2) Fitting and Assessing

- 80% of training data and 
- 20% of data is into Testing
...
Split_Data <- initial_split(Test, prop = 0.80)

# assign the two splits to data frames - with descriptive names
diamonds_train <- training(Split_Data)
diamonds_test <- testing(Split_Data)
...
### ASSESSING WITH TESTING DATASET

_ here in the below chunk of code Reg is the linear regression model data fit from the above.


```{r}

slr_aug <- augment(Reg, new_data = Test)
slr_aug
...
### predict the data as per the above assessing the data

```{r}

predict(Reg, new_data = diamonds_test)
